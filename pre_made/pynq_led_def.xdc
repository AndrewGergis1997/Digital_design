...
connect_debug_port u_ila_0/probe0 [get_nets [list {alien_color[23]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 8 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {alien_x[0]} {alien_x[1]} {alien_x[2]} {alien_x[3]} {alien_x[4]} {alien_x[5]} {alien_x[6]} {alien_x[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {btn_IBUF[0]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 8 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {U_0/yr[0]} {U_0/yr[1]} {U_0/yr[2]} {U_0/yr[3]} {U_0/yr[4]} {U_0/yr[5]} {U_0/yr[6]} {U_0/yr[7]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe5 [get_nets [list Enable]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe7 [get_nets [list U_1/hit]]
