-- VHDL Entity alien_game_lib.c4_t1_m2.symbol
--
-- Created:
--          by - mqange.UNKNOWN (HTC219-712-SPC)
--          at - 21:12:40 17.11.2022
--
...
--
-- VHDL Architecture alien_game_lib.c4_t1_m2.struct
--
-- Created:
--          by - mqange.UNKNOWN (HTC219-712-SPC)
--          at - 21:12:40 17.11.2022
...
ARCHITECTURE struct OF c4_t1_m2 IS
...
BEGIN
   ...
   din2 <= btn(3) AND NOT(x_coordinate_internal(1)) AND enable;

   -- ModuleWare code(v1.12) for instance 'U_12' of 'and'
   din1 <= btn(1) AND NOT(x_coordinate_internal(6)) AND enable;
