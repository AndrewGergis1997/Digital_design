...
BEGIN
      ...
      CASE current_state IS
         WHEN Start => 
            IF (write_ready = '0') THEN 
               next_state <= Start;
            ELSIF (alien_defeated = '1'
                   AND write_ready = '1') THEN 
               next_state <= s4;
            ELSIF (write_ready = '1' AND  alien_defeated = '0') THEN 
               next_state <= wr;
            ELSE
               next_state <= Start;
            END IF;
   ...
   BEGIN
      ...
      ELSIF (csm_to_s5 = '1') THEN
         csm_next_timer <= "000000000000000011000111"; -- no cycles(200)-1=199
      ELSE
