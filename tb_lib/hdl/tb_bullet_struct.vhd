...
ARCHITECTURE struct OF tb_bullet IS
   ...
   FOR ALL : c4_t2_bullet USE ENTITY alien_game_lib.c4_t2_bullet;
   -- pragma synthesis_on
...
BEGIN
   ...
   U_1 : c4_t2_bullet
      PORT MAP (
         ...
         clk                  => clk,
         enable               => en,
         gun_x_coordinates    => gun_x,
         rst_n                => rst_n,
         bullet_x_coordinates => bullet_x,
         bullet_y_coordinates => bullet_y,
         color                => bullet_colour
      );
